...
1. argv construction from validated params  ← this story (`argv.py`)
2. cache-manifest reading for `GET /regions`  (Story 1.6)
3. params-schema introspection from the CLI arg parser  (Epic 2)
4. stdout line classification into the progress model  (Story 1.4)
...
__all__ = ["build_setup_argv", "resolve_setup_executable"]
